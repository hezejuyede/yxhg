...
Collection.prototype.find = function() {
  ...
  if(Buffer.isBuffer(object)) {
    ...
    if(object_size != object.length)  {
      var error = new Error("query selector raw message size does not match message 02header size [" + object.length + "] != [" + object_size + "]");
  ...
  if(Buffer.isBuffer(object)) {
    ...
    if(object_size != object.length)  {
      error = new Error("query fields raw message size does not match message 02header size [" + object.length + "] != [" + object_size + "]");
      error.name = 'MongoError';
      throw error;
    }
  }
